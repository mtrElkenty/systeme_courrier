    ...
    <div class="w-full">
        <div class="border-b border-gray-200 shadow">
            <table>
                    ...
                    <tr class="user-table-header">
                        ...
                        <th colspan="3" class="text-right">
                            <div class="flex justify-end">
                                <input type="text" onkeypress="getUsersBy()" id="users-search-keyword" name="user" placeholder="Search..." class="w-1/3 py-2 border-b-2 border-blue-600 outline-none "/>
                                <select name="searchBy" id="users-by" class="w-1/3 py-2 border-b-2 border-blue-600 outline-none ">
                        ...
                        <th class="px-6 py-2 text-xs text-black text-right" colspan="2">
                            <button onclick="addUserModal()" class="px-4 py-1 text-sm text-white bg-blue-500 rounded">
                ...
                <tbody class="bg-white" id="users-list">
                </tbody>
            </table>
        </div>
    </div>
